...
<div class="d-flex justify-content-center align-items-center min-vh-100">
    <div class="card-container text-center">
        ...
        <h3 class="fw-bold display-6 text-dark mb-4">Patient Login</h3>
        ...
        <form action="patientLogin" method="post">
            ...
            <div class="mb-3 text-start">
                ...
                <input type="email" class="form-control" id="emailId" name="email"
                       onchange="userPatientEmail()" placeholder="Enter email" required>
                <p id="displayEmail"></p>
            </div>


            <button type="button" class="btn btn-primary btn-custom" onclick="sendOtpToPatient()">Send OTP</button>
...
<script>
    ...
    function userPatientEmail() {
        let email = document.getElementById("emailId").value;
        if (!email) return;

        const xhttp = new XMLHttpRequest();
xhttp.open("GET", "http://localhost:8080/Hospital/api/PatientEmail/" + encodeURIComponent(email), true);
        xhttp.send();
    ...
    function sendOtpToPatient() {
        ...
        const xhttp = new XMLHttpRequest();
        xhttp.open("GET", "http://localhost:8080/Hospital/api/sendOtp/" + encodeURIComponent(email), true);
        xhttp.send();
